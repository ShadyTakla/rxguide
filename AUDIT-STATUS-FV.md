...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~781 of 1546 cards verified; resume at index.html line ~217,200 (card ~782, post-erythromycin-ophthalmic)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
