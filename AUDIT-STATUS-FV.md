...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~866 of 1546 cards verified; resume at index.html line ~225,023 (card ~867, ruxolitinib)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
