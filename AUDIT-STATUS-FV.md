...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~821 of 1546 cards verified; resume at index.html line ~221,283 (card ~822, mid-sulfamethoxazole)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
