...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~859 of 1546 cards verified; resume at index.html line ~224,397 (card ~860, post-deferiprone)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
