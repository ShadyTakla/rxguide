...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~790 of 1546 cards verified; resume at index.html line ~218,028 (card ~791, mometasone-nasal)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
