...
**Net remaining FV work:** DRUGS full-verbatim re-verification in progress on this branch (~853 of 1546 cards verified; resume at index.html line ~223,825 (card ~854, post-romiplostim)). NAPRA_ODB_DATA (full-app-audit branch, in progress). All other catalogs are FV-complete (first pass).
