...
**Catalog snapshot:** 2,877 clickable entries (latest commit: `5489fa5 on 2026-05-17`)
...
| **NAPRA_ODB_DATA (drug scheduling / ODB coverage)** | 1,547 | ≈ 270 / 1,547 (~17%) | IN PROGRESS — first pass | Batches 1-2 (2026-05-17): first ~270 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric, GI, respiratory, analgesic, bone/GU drugs). 2 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen entry reconstructed (malformed name + truncated odbDetail/notes fields). Remaining ~1,280 entries pending batched review. |
