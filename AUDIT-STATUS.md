...
**Catalog snapshot:** 2,886 clickable entries (latest commit: `a3c5ad0 on 2026-05-19`)
...
| **REFERENCE_TABLES** | 106 | 100.0% | 100.0% |
...
| `related_drugs` all resolve to DRUGS/VACCINES | **100.0%** | `██████████████████` | 106 | 0 |
