...
**Catalog snapshot:** 2,877 clickable entries (latest commit: `3d652f0 on 2026-05-17`)
...
| **NAPRA_ODB_DATA (drug scheduling / ODB coverage)** | 1,547 | ≈ 135 / 1,547 (~9%) | IN PROGRESS — first pass | Batch 1 (2026-05-17): first ~135 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric). 1 fix — ceftriaxone gonorrhea dose corrected 250 mg → 500 mg IM (current PHAC STBBI guidance; aligns with AMR_DATA + PREG_DATA). Remaining ~1,400 entries pending batched review. |
