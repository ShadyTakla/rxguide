...
**Catalog snapshot:** 2,882 clickable entries (latest commit: `596ff01 on 2026-05-15`)
...
## DRUG_FAMILIES (544 entries)

| Audit dimension | Coverage | Bar | Audited (clean) | Remaining |
|---|---|---|---|---|
| Full required schema (moa_summary, class_effects, contraindications, members, pearls, source) | **100.0%** | `██████████████████` | 544 | 0 |
| Non-empty `members[]` | **100.0%** | `██████████████████` | 544 | 0 |
| Canadian source / canadian_notes | **100.0%** | `██████████████████` | 544 | 0 |
| `class_effects` depth ≥ 3 items | **100.0%** | `██████████████████` | 544 | 0 |
| `class_contraindications` depth ≥ 2 items | **100.0%** | `██████████████████` | 544 | 0 |
...
| `aml` | [oncology] {"rows":[{"line":"First-Line — Newly-Diagnosed AML (Fit; <70-75 with adequate function)","missing":[]},{"line":"Relapsed / Refractory (R/R AML)","missing":[]}]} |
| `all` | [oncology] {"rows":[{"line":"Induction — Adult Ph-Negative ALL","missing":[]},{"line":"Relapsed / Refractory","missing":[]}]} |
