...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 1,152 / 1,547 (~74%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-11 (2026-05-17): first ~1,152 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine incl. bone agents, psychiatric, GI, respiratory, analgesic, dermatology, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV/HCV/HBV antivirals, antifungals, TB drugs, antiparasitics/antimalarials, hospital antibiotics, antihistamines/decongestants, immunology biologics, oncology, OAB/alpha-blockers, obstetric agents, iron salts, OTC topicals, natural health products, insulin). 7 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen + pyrantel entries reconstructed; "triplicate prescription required in Ontario" corrected on 3 stimulant entries; glecaprevir/pibrentasvir Maviret duration corrected. 3 flagged for verification (ulipristal_acetate, mometasone_nasal — Rx/OTC contradictions; timolol_ophthalmic — sparse duplicate of timolol_ophth). Remaining ~395 entries pending batched review.' },
