...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 405 / 1,547 (~26%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-3 (2026-05-17): first ~405 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric, GI, respiratory, analgesic, dermatology, biologic, bone/GU drugs). 2 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen entry reconstructed (malformed name + truncated odbDetail/notes fields). Remaining ~1,140 entries pending batched review.' },
