...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 920 / 1,547 (~59%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-8 (2026-05-17): first ~920 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric, GI, respiratory, analgesic, dermatology, biologic, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV/HCV/HBV antivirals, antifungals, TB drugs, antiparasitics/antimalarials, hospital antibiotics). 7 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen + pyrantel entries reconstructed (malformed names + truncated fields); "triplicate prescription required in Ontario" corrected on 3 stimulant entries (Ontario uses the Narcotics Monitoring System, not triplicate pads); glecaprevir/pibrentasvir Maviret 8-week compensated-cirrhosis duration corrected. 2 flagged for verification (ulipristal_acetate, mometasone_nasal). Remaining ~625 entries pending batched review.' },
