...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 1,015 / 1,547 (~66%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-9 (2026-05-17): first ~1,015 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric, GI, respiratory, analgesic, dermatology, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV/HCV/HBV antivirals, antifungals, TB drugs, antiparasitics/antimalarials, hospital antibiotics, antihistamines/decongestants, immunology biologics — TNF/IL-17/IL-23/JAK inhibitors, aromatase inhibitors). 7 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen + pyrantel entries reconstructed; "triplicate prescription required in Ontario" corrected on 3 stimulant entries; glecaprevir/pibrentasvir Maviret duration corrected. 2 flagged for verification (ulipristal_acetate, mometasone_nasal). Remaining ~530 entries pending batched review.' },
