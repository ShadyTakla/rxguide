...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 540 / 1,547 (~35%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-4 (2026-05-17): first ~540 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric, GI, respiratory, analgesic, dermatology, biologic, muscle relaxant, migraine, gout, hormonal/reproductive drugs). 2 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen entry reconstructed (malformed name + truncated odbDetail/notes). 1 flagged for verification (ulipristal_acetate — internal contradiction on Canadian Rx status). Remaining ~1,000 entries pending batched review.' },
