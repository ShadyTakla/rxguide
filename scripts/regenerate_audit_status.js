...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 1,110 / 1,547 (~72%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-10 (2026-05-17): first ~1,110 entries reviewed (antimicrobials, cardiovascular, antithrombotic incl. anticoagulants/thrombolytics, endocrine, psychiatric, GI, respiratory, analgesic, dermatology, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV/HCV/HBV antivirals, antifungals, TB drugs, antiparasitics/antimalarials, hospital antibiotics, antihistamines/decongestants, immunology biologics, oncology — CDK4/6 inhibitors/antiandrogens/TKIs/cytotoxics, OAB/alpha-blockers, obstetric agents). 7 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen + pyrantel entries reconstructed; "triplicate prescription required in Ontario" corrected on 3 stimulant entries; glecaprevir/pibrentasvir Maviret duration corrected. 2 flagged for verification (ulipristal_acetate, mometasone_nasal). Remaining ~437 entries pending batched review.' },
