...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 1,240 / 1,547 (~80%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-13 (2026-05-17): first ~1,196 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine incl. bone agents, psychiatric, GI, respiratory, analgesic, dermatology, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV/HCV/HBV antivirals, antifungals, TB drugs, antiparasitics/antimalarials, hospital antibiotics, antihistamines/decongestants, immunology biologics, oncology incl. ICIs/targeted agents, OAB/alpha-blockers, obstetric agents, iron salts, OTC topicals, natural health products, insulin, antiseizure, statins/fibrates, ESAs/G-CSF, antiarrhythmics). 9 fixes — ceftriaxone gonorrhea dose; naproxen + pyrantel entries reconstructed; "triplicate prescription" corrected on 3 stimulant entries; glecaprevir/pibrentasvir Maviret duration; phenobarbital mislabeled "Targeted Substance" → controlled drug; epoetin_alfa odbDetail typo + luCode contradiction. 4 flagged for verification (ulipristal_acetate, mometasone_nasal, timolol_ophthalmic duplicate, nabilone CDSA Schedule II-vs-III contradiction). Remaining ~351 entries pending batched review.' },
