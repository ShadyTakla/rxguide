...
const FV_AUDIT = {
  ...
  rows: [
    ...
    { catalog: 'NAPRA_ODB_DATA (drug scheduling / ODB coverage)', entries: 1547, coverage: '≈ 825 / 1,547 (~53%)', status: 'IN PROGRESS — first pass',
      evidence: 'Batches 1-7 (2026-05-17): first ~825 entries reviewed (antimicrobials, cardiovascular, antithrombotic, endocrine, psychiatric incl. LAI antipsychotics + ADHD stimulants, GI, respiratory, analgesic, dermatology, biologic, ophthalmic/otic/nasal, immune globulin, addiction medicine, NRT, neurology, HIV antiretrovirals, HCV/HBV antivirals, antifungals). 6 fixes — ceftriaxone gonorrhea dose 250→500 mg IM; naproxen entry reconstructed; "triplicate prescription required in Ontario" corrected on 3 stimulant entries (Ontario uses the Narcotics Monitoring System, not triplicate pads); glecaprevir/pibrentasvir Maviret 8-week compensated-cirrhosis duration corrected. 2 flagged for verification (ulipristal_acetate, mometasone_nasal). Remaining ~720 entries pending batched review.' },
